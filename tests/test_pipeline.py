...
def test_variable_inputs():
    ...
    node1 = ProcessNode(name='node1', executable='node1', out_paths={'output': 'path1'}, node_dpath='.')
    node2 = ProcessNode(name='node2', executable='node2', out_paths={'output': 'path2'}, node_dpath='.')
    node3 = ProcessNode(name='node3', executable='node3', out_paths={'output': 'path3'}, node_dpath='.')
