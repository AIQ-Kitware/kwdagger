...
Notes:
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/kwdagger/advanced/
        ...
        For gitlab you also need to setup an integrations. Navigate to:
            ...
            https://readthedocs.org/dashboard/kwdagger/integrations/create/
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/kwdagger/versions/
"""
#
...
mod_dpath = join(repo_dpath, 'kwdagger')
...
# html_logo = '.static/kwdagger.svg'
# html_favicon = '.static/kwdagger.ico'
...
latex_documents = [
    (master_doc, 'kwdagger.tex', 'kwdagger Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'kwdagger', 'kwdagger Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'kwdagger', 'kwdagger Documentation',
     author, 'kwdagger', 'One line description of project.',
     'Miscellaneous'),
]
